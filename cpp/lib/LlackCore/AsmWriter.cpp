...
#include "llack/CallingConv.h"
#include "llack/Constants.h"
#include "llack/DerivedTypes.h"
#include "llack/InlineAsm.h"
#include "llack/Instruction.h"
#include "llack/Instructions.h"
#include "llack/Module.h"
#include "llack/ValueSymbolTable.h"
#include "llack/TypeSymbolTable.h"
#include "llack/Support/CFG.h"
#include "llack/Assembly/PrintModulePass.h"
#include "llack/Assembly/AsmAnnotationWriter.h"
#include "llack/Assembly/Writer.h"
...
using llvm::DenseMap;
using llvm::DoubleToBits;
using llvm::errs;
using llvm::next;
using llvm::pred_const_iterator;
...
///
void llack::WriteTypeSymbolic(std::ostream &Out, const Type *Ty,
                             const Module *M) {
  raw_os_ostream RO(Out);
  WriteTypeSymbolic(RO, Ty, M);
}

void llack::WriteTypeSymbolic(raw_ostream &Out, const Type *Ty, const Module *M){
  Out << ' ';
...
/// the whole instruction that generated it.
///
void llack::WriteAsOperand(std::ostream &Out, const Value *V, bool PrintType,
                          const Module *Context) {
  raw_os_ostream OS(Out);
  WriteAsOperand(OS, V, PrintType, Context);
}

void llack::WriteAsOperand(raw_ostream &Out, const Value *V, bool PrintType,
                          const Module *Context) {
  std::map<const Type *, std::string> TypeNames;
