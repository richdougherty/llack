...
using llvm::Log2_32;
using llvm::gep_type_begin;
using llvm::gep_type_end;
using llvm::gep_type_iterator;
...
Constant *llack::ConstantFoldCastInstruction(unsigned opc, const Constant *V,
                                            const Type *DestTy) {
  if (isa<UndefValue>(V)) {
...
Constant *llack::ConstantFoldSelectInstruction(const Constant *Cond,
                                              const Constant *V1,
                                              const Constant *V2) {
...
Constant *llack::ConstantFoldExtractElementInstruction(const Constant *Val,
                                                      const Constant *Idx) {
...
Constant *llack::ConstantFoldInsertElementInstruction(const Constant *Val,
                                                     const Constant *Elt,
                                                     const Constant *Idx) {
...
Constant *llack::ConstantFoldShuffleVectorInstruction(const Constant *V1,
                                                     const Constant *V2,
                                                     const Constant *Mask) {
...
Constant *llack::ConstantFoldExtractValueInstruction(const Constant *Agg,
                                                    const unsigned *Idxs,
                                                    unsigned NumIdx) {
...
Constant *llack::ConstantFoldInsertValueInstruction(const Constant *Agg,
                                                   const Constant *Val,
                                                   const unsigned *Idxs,
                                                   unsigned NumIdx) {
...
Constant *llack::ConstantFoldBinaryInstruction(unsigned Opcode,
                                              const Constant *C1,
                                              const Constant *C2) {
  // No compile-time operations on this type yet.
...
Constant *llack::ConstantFoldCompareInstruction(unsigned short pred, 
                                               const Constant *C1, 
                                               const Constant *C2) {
...
Constant *llack::ConstantFoldGetElementPtr(const Constant *C,
                                          Constant* const *Idxs,
                                          unsigned NumIdx) {
  if (NumIdx == 0 ||
