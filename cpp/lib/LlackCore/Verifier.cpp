...
#include "llack/Analysis/Verifier.h"
...
#include "llack/Pass.h"
#include "llack/PassManager.h"
...
#include "llack/Support/InstVisitor.h"
...
FunctionPass *llack::createVerifierPass(VerifierFailureAction action) {
  return new Verifier(action);
}


// verifyFunction - Create
bool llack::verifyFunction(const Function &f, VerifierFailureAction action) {
...
///
bool llack::verifyModule(const Module &M, VerifierFailureAction action,
