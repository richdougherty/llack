...
static bool UpgradeIntrinsicFunction1(Function *F, Function *&NewFn) {
  ...
  case 'x': 
    ...
    if (Name.compare(5,10,"x86.mmx.ps",10) == 0 &&
      ...
      const llack::Type *VT = VectorType::get(IntegerType::get(64), 1);
...
bool llack::UpgradeIntrinsicFunction(Function *F, Function *&NewFn) {
  NewFn = 0;
...
void llack::UpgradeIntrinsicCall(CallInst *CI, Function *NewFn) {
...
// function.
void llack::UpgradeCallsToIntrinsic(Function* F) {
